// Listening tools ported from rtai-mobile/terminal (v1.3.11).
// The interactive TUI-integration case targets the legacy modular layout engine;
// v1.4.4 ships the Spotify-style visualizer dashboard (src/tui.js), so it is skipped
// in CI. Pure search / sleep / favorites logic is fully tested below.
...
test('interactive keys search, play, schedule sleep and preserve sign-in navigation (legacy 1.3.11 flow)', {skip: 'skipped on v1.4.4 visualizer dashboard - covered by layout.test.js + core.test.js'}, () => {
